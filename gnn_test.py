...
"""
n_iters=100    # flexibility to change this
n_node_features=500
n_edge_features=500
...
fname = f"trained_models/d{d}_DP_30_500_500_200000_0.15_10000_0.05_0.0001_0.0001_512_0.05_0.05_"

dist=5   # distance to test on
...
# load_model(gnn, fname + 'gnn.pth 0.0314_0.0006 29', device) #d3
load_model(gnn, fname + 'gnn.pth 0.0108_0.0027 50', device) #d5
# load_model(gnn, fname + 'gnn.pth 0.0037_0.0012 30', device) #d7
...
len_test_set = 10**5
gnn.eval()
print(f"i, err_rate, fraction_solved, lerx, lerz, ler_tot, test_loss")
with torch.no_grad():
